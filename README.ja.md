...
- **画面共有で非表示。** スイッチひとつで、Sill Note は画面録画、画面共有（Zoom、Teams、Discord、OBS）、スクリーンショットに写らなくなります。自分の画面では表示されたままです。
- **不透明度。** パネルの背景を透明に（60〜100%）。文字や画像はくっきりしたままです。
- **集中ビュー。** サイドバーボタンでノート一覧を隠し、ノートをパネル全体に広げます。
...
<sub>スクリーンショットはサンプルの内容です。動画サムネイル：*Big Buck Bunny* © Blender Foundation, [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/)</sub>
